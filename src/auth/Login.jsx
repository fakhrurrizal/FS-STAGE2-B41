...
export default function Login(props) {
  ...
  return(
    <Modal
      ...
      centered
    >
      <Modal.Body style={{height: "25rem",  paddingLeft: "50px", paddingRight: "50px"}}>
      <h1 className= 'text-danger fw-bold' style={{fontSize:"36px"}}>Login</h1>
      <Form>
        ...
        <Button className= 'btnLoginApp mt-4'  size="lg">
          Login
        </Button>
        </div>
